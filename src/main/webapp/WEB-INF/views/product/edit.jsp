...
<body>
	...
	<h1><fmt:message key="title.editProduct"/></h1>
	<f:form action="/product/edit/${product.id}" method="POST" commandName="product">
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td>&nbsp;&nbsp;</td>
					<td><input type="submit" name="productUpdate" value="<fmt:message key='form.update'/>"/></td>
				</tr>
			</tbody>
		</table>
	</f:form>
